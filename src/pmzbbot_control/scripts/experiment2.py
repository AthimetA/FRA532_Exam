...
from pmzbbot_interfaces.srv import PmzbbotBeginOdomExperiment
import yaml
import pandas as pd
import os
...
class PMZBExperimentTestNode(Node):
    ...
    def __init__(self):
        ...
        # Service
        self.srv = self.create_service(PmzbbotBeginOdomExperiment, '/pmzb_experiment_odom' , self.begin_calibration_callback)
    ...
    def begin_calibration_callback(self, request: PmzbbotBeginOdomExperiment.Request, response: PmzbbotBeginOdomExperiment.Response):
